...
class PreprocessNetflixData(gokart.TaskOnKart):
    ...
    def output(self):
        return self.make_target('netflix/preprocess_for_gc.pkl')
...
class GraphConvolutionalMatrixCompletionExample(gokart.TaskOnKart):
    ...
    def run(self):
        ...
        model = self.load('model')  # type: redshells.model.GraphConvolutionalMatrixCompletion
