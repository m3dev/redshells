...
class TrainSCDVWithExistingFile(gokart.TaskOnKart):
    ...
    def requires(self):
        ...
        scdv = redshells.train.TrainSCDV(tokenized_text_data_task=text_data, dictionary_task=dictionary, word2vec_task=fasttext)
        return scdv
...
if __name__ == '__main__':
    ...
    luigi.run(['examples.TrainSCDVWithExistingFile', '--text-data-file-path', './resources/sample_tokenized_data.pkl', '--local-scheduler'])
